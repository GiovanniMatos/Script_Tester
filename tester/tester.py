...
def compare_html_css_js(html_file, css_file, js_file):
    ...
    # Verifica as variaveis do Javascript
    print(linha_terminal)
    print("\033[1;32mVariaveis do Javascript\033[0;0m \n")

    # Mostrar as linhas filtradas
    for linha in linhas_js:
        if re.search("var", linha):
            print(linha)
        elif re.search("const", linha):
            print(linha) 
        elif re.search("let", linha):
            print(linha)
        elif re.search("double", linha):
            print(linha) 

    print(f"{linha_terminal}\n")
